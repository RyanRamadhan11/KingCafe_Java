...
import com.enigma.kingcaffe_java.dto.response.OrderDetailResponse;
...
import com.enigma.kingcaffe_java.repository.*;
import com.enigma.kingcaffe_java.service.CategoryService;
import com.enigma.kingcaffe_java.service.MenuPriceService;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderResponse getOrderById(String id) {
        ...
        try {
            ...
            Short orderTypeValue = (Short) result[3];
            EOrderType orderType = null;

            if (orderTypeValue != null) {
                switch (orderTypeValue) {
                    case 0:
                        orderType = EOrderType.EAT_IN;
                        break;
                    case 1:
                        orderType = EOrderType.ONLINE;
                        break;
                    case 2:
                        orderType = EOrderType.TAKE_AWAY;
                        break;
                    default:
                        // Handle unknown order type if necessary
                        break;
                }
            }
